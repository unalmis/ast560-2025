...
% \section{A Note on Initializing Discretely Divergence-Free Fields}

% In the above we have allowed arbitrary flow fields
% $\mvec{u}(\mvec{x},t)$. However, many problems of interest the
% flow-field is incompressible, for example, in incompressible
% Navier-Stokes equations, and many kinetic problems in plasma physics.
